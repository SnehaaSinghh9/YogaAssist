...
export const tutorials = [
    '1. Permit the app to access the camera to take a picture of your Yoga Pose.',
    '2. From the dropdown menu, choose the pose you wish to perform.',
    '3. To learn how to perform a certain stance, follow the instructions provided.',
    '4. Press the "Start Pose" button to view the image of the stance on the right and repeat it in front of the camera.',
    "5. If you follow the instructions successfully, the video's skeleton will turn green and music will begin to play."
]

export const fixCamera = [
    "Solution 1. Verify that you have granted permission for the camera to access the application. If not, go to your browser's settings and grant the camera access.",
    'Solution 2. Ensure that no other application is using the camera at that moment; if it is, close that application',
    'Solution 3. Attempt to shut off every other browser that has been launched.'
] 
